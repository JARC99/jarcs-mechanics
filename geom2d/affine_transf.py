...
class AffineTransform:
    ...
    def apply_to_point(self, point: Point):
        return Point(
            ...
            (self.sy * point.y) + (self.shy * point.x) + self.ty,
        )
    ...
    def __eq__(self, other):
        ...
        return are_close_enough(self.sx, other.sx) and are_close_enough(self.sy, other.sy) and are_close_enough(self.tx,
                                                                                                                other.tx) and are_close_enough(
            self.ty, other.ty) and are_close_enough(self.shx, other.shx) and are_close_enough(self.shy, other.shy)
